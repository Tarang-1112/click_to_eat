              ...
              child: TextButton(
                ...
                onPressed: () async {
                  ...
                  if (!await productProvider.editProduct(
                    ...
                    name: productProvider.name.text,
                    description: productProvider.description.text,
                    price: double.parse(productProvider.price.text),
                  )) {
                  ...
                  _key.currentState!.showSnackBar(SnackBar(
                    content: Text("Edit completed"),
                    duration: const Duration(seconds: 1),
                  ));
                  // productProvider.loadProductsByRestaurant(
                  //     restaurantId: restroAdminProvider.restaurantModel.id);
